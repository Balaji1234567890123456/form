...
class AllProductsSection extends Component {
  ...
  getProducts = async () => {
    ...
    if (response.ok) {
      ...
      this.setState({status: a.isFailure})
    }
  }
  ...
  changeSearchInput = oye => {
    this.setState({titleSearch: oye}, this.getProducts)
  }
  ...
  renderProductsList = () => {
    ...
    const roy = productsList.length > 0
    ...
    return (
      <div className="all-products-section">
        ...
        <FiltersGroup
          ...
          enterSearchInput={this.searchInput}
...
class AllProductsSection extends Component {
  ...
  renderProductsListView = () => {
    ...
    console.log(shouldShowProductsList)
